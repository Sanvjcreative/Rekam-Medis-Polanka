...
Route::prefix('datatables')->middleware('auth')->group(function () {
    Route::get('pasien', [DataTablesController::class, 'getPasien'])->name('datatables.pasien');
    Route::get('antrian', [DataTablesController::class, 'getAntrian'])->name('datatables.antrian');
    Route::get('antrian-selesai', [DataTablesController::class, 'getAntrianSelesai'])->name('datatables.antrian.selesai');
    Route::get('antrian-stats', [DataTablesController::class, 'getAntrianStats'])->name('datatables.antrian.stats');
    Route::get('users', [DataTablesController::class, 'getUsers'])->name('datatables.users');
    Route::get('jadwal', [DataTablesController::class, 'getJadwal'])->name('datatables.jadwal');
});
